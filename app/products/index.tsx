...
export default function ProductsScreen() {
    ...
    // RECARREGA SEMPRE QUE A TELA GANHA FOCO (Resolve o bug de não atualizar)
    useFocusEffect(
        useCallback(() => {
            loadProducts();
        }, [])
    ...
    const renderProductItem = ({ item }: { item: Product }) => (
        <TouchableOpacity
            style={styles.card}
            activeOpacity={0.7}
            onPress={() => router.push({ pathname: '/products/new', params: { id: item.id } })}
        >
...
const styles = StyleSheet.create({
    ...
    filterBtn: {
        ...
        padding: 12, borderRadius: 12, borderWidth: 1, borderColor: '#E5E7EB', alignSelf: 'flex-start'
    },
